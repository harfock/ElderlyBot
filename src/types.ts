    ...
    items: [
      {
        ...
        fullTip: "請坐在穩固的椅子上，雙手自然放在膝蓋。慢慢將頭轉向左邊，停留3秒，再慢慢轉向右邊，停留3秒。重複動作，不要用力過猛、不要太快[...]",
        fullTipCantonese: "請坐喺張穩陣嘅椅上面，兩手自然放喺膝頭。慢慢將個頭轉去左邊，停三秒，再慢慢轉去右邊，停三秒。重複動作，唔好太用力、[...]",
        voiceText: "頭部運動。請坐在穩固的椅子上，慢慢將頭轉向左邊，停留三秒，再慢慢轉向右邊，停留三秒。速度要慢，不要用力過猛。如果有頭暈，[...]",
        voiceTextCantonese: "頭部運動。請坐喺穩陣嘅椅上面，慢慢將個頭轉去左邊，停三秒，再慢慢轉去右邊，停三秒。速度要慢，唔好太用力。如果覺得頭[...]"
      },
      {
        id: "ex_arms",
        emoji: "🙌",
        ...
        fullTip: "吸氣時，雙手手掌朝上慢慢舉高至頭頂上方（若肩膀酸痛，舉到舒適的高度即可），掌心相對。吐氣時，雙臂慢慢由身體兩側畫大圓放下[...]",
        fullTipCantonese: "吸氣嗰陣，兩手手掌朝上慢慢舉高到頭頂上面（如果膊頭酸痛，舉到舒服嘅高度就得），兩掌相對。呼氣嗰陣，對手慢慢由身體兩[...]",
      ...
      },
      {
        ...
        fullTip: "坐在椅子上，身體坐正，雙腳平貼地面。雙手叉腰或輕扶大腿，以腹部為中心，輕輕地將上身向左後方旋轉，再慢慢轉回，接著向右後[...]",
        fullTipCantonese: "坐喺張椅上面，個人坐直，兩隻腳踏實地面。雙手叉腰或者輕輕扶住大腿，以肚為中心，輕輕將上身向左邊拧，再慢慢轉返嚟，之[...]",
      ...
      },
      {
        ...
        fullTip: "坐在有靠背的穩固椅子上，雙手扶住椅子邊緣。一邊膝蓋慢慢伸直，腳尖朝上，將小腿抬平，停留3秒後放下，再換另一隻腳。此動作能[...]",
        fullTipCantonese: "坐喺有椅背嘅穩陣椅上面，雙手扶住椅邊。一邊膝頭慢慢伸直，腳面向上，將小腿抬平，停三秒後放低，再換另一隻腳。呢個動[...]",
        voiceText: "活動雙腿.坐在穩固的椅子上，扶好扶手。把一隻腳往前踢平，腳尖朝上指，停留三秒再放下。接著換另一隻腳踢踢看。這能讓雙腿更[...]",
        voiceTextCantonese: "活動對腳。坐喺穩陣椅上面，雙手扶好椅邊。將一邊嘅腳向前慢慢踢直，腳尖向上指，停三秒再放低。然後再換另一隻腳踢。咁[...]"
      },
      {
        id: "ex_back",
        emoji: "🧍",
        ...
        fullTip: "坐在椅子前緣（椅子要穩固），雙腳打開與肩同寬，踩實地面。雙手抱著對側肩膀，身體慢慢向前微微傾斜，低頭並讓背部微拱，感覺[...]",
        fullTipCantonese: "坐喺椅前（張椅要穩陣），兩隻腳打開到同肩膊一樣闊，踩實個地。雙手交叉抱住對面膊頭，個人慢慢向前傾少少，耷低頭並讓[...]",
      ...
      },
      {
        ...
        fullTip: "雙手在胸前伸直。雙手用力張開，十指盡量展開到最大，維持2秒；然後用力握緊拳頭，維持2秒。這樣一開一合為一次，連續做10次。[...]",
        fullTipCantonese: "對手喺胸前伸直。雙手用力展開，十隻手指盡量撐到最大，維持兩秒；然後用力握緊拳頭，維持兩秒。一開一合為之一組，連續[...]",
    ...
    items: [
      {
        ...
        fullTip: "豐盛美味又营养的飯菜已經準備好了！在開飯前，請記得先用肥皂肥皂仔細搓洗雙手至少20秒。乾淨衛生的雙手是防範感冒與病毒侵襲[...]",
        fullTipCantonese: "香噴噴、精緻營養嘅飯菜準備就緒啦！食飯之前，記住先用番鹼洗清對手，搓手搓足至少二十秒。洗乾淨雙手能極好防範流感同[...]",
      ...
      },
      {
        ...
        fullTip: "今天的菜色合您的口味嗎？是否會太鹹、太淡或太油？如果覺得不合胃口、或者是食物煮得不夠軟爛不方便咬，請隨時告訴家人或照護[...]",
        fullTipCantonese: "今日嘅飯菜啱唔啱你口味呀？會唔會太鹹、太淡，或者太油膩？如果覺得唔夠合意，或者覺得啲嘢食煮得唔夠爛、比較難咬，隨[...]",
      ...
      },
      {
        ...
        fullTip: "熱湯和熱菜剛出爐時溫度很高，請一定要先吹一吹，不求快。一筷一筷慢慢夾，小口喝湯，特別是稀飯或湯麵，保證吞嚥安全，避免因[...]",
        fullTipCantonese: "滾湯同熱餸熱辣辣啱啱出爐，熱度好高，食之前一定要吹吹佢，唔好求快。一筷子一筷子慢慢夾，一細口一細口飲湯。食粥或[...]",
        voiceText: "小心慢慢吃。熱湯與菜餚剛做好可能很燙，夾起來先吹一吹。一口一口慢慢送進嘴裡，順暢吞嚥，千��不要著急喔。",
      ...
      },
      {
        ...
        fullTip: "多補充綠色蔬菜可以提供豐富的膳食纖維、維生素C及多種微量元素，不僅可以預防便祕、幫助排便、維持腸胃健康，更對控制血壓非[...]",
        fullTipCantonese: "食多啲綠色蔬菜能提供滿滿膳食纖維、維他命同豐富營養，不單止可以改善便秘，幫助排便，對維持血壓平穩都好有益處！今日[...]",
      ...
      },
      {
        ...
        fullTip: "每一口食物建議在嘴裡咀嚼至少15到20下。將食物嚼得越細碎，唾液揉合越充分，食物進入腸胃就越容易磨碎與吸收，能大大減少脹[...]",
        fullTipCantonese: "食嘢嗰陣，每一一小口最好喺口中慢慢嚼足十五至二十下。把食物咬得碎腐一啲，落去肚入面就最容易消化吸收，最能減少肚脹[...]",
      ...
      },
      {
        ...
        fullTip: "您吃飽了嗎？感覺肚肚八分飽是最舒服、最沒有負擔的。吃飽了可以先喝幾口溫水，坐在椅子上和周圍人聊聊天，不要立刻躺到床上[...]",
        fullTipCantonese: "你飽飽未呀？食到八成飽係對身體同胃部最舒服、最冇負擔嘅。食飽之後，可以飲番落兩啖暖水，坐喺椅上和大家傾下偈，千祈[...]",
    ...
    items: [
      {
        ...
        fullTip: "吃藥時間到了！請對照藥袋上的叮囑，分清是飯前還是飯後服用。請搭配一整杯溫開水（至少200毫升）吞服，萬萬不可用冰水、茶或[...]",
        fullTipCantonese: "夠鐘食藥啦！請睇清藥袋上面嘅叮嚀，分清係飯前食定飯後食。請配一整杯暖開水吞藥，記住唔好用冰水、茶水或者果汁吞，咁[...]",
      ...
      },
      {
        ...
        fullTip: "水分是生命之源，特別是溫開水更溫和不刺激胃部。每次喝個兩三口，少量多次，能促進體內廢物排出，維持血液循環暢通，特別是清[...]",
        fullTipCantonese: "水係有益健康嘅！特別係暖開水對腸胃最溫和。每次飲兩三啖，好水不離身。多飲暖水可以幫助體內排毒、順暢血液。尤其是朝[...]",
      ...
      },
      {
        ...
        fullTip: "每天早晚可以在身體平靜、休息5分鐘後，使用血壓計進行測量。測量時手臂與心臟同高，背部靠著椅背，不說話。隨手把數值記錄在[...]",
        fullTipCantonese: "每日早晚可以在身心放鬆、坐低休息大約五分鐘後，用血壓計測量一測。量血壓嗰陣，手臂與心臟一樣高，背脊放鬆靠住椅背，[...]",
        voiceText: "我們來量量血壓吧。請先安靜地坐好，休息五���鐘。套上血壓套後，不要說話，保持平心靜氣，量完記得記錄數值喔。",
      ...
      },
      {
        ...
        fullTip: "請放鬆雙肩。用鼻子慢慢吸氣，感覺腹部慢慢鼓起來（維持4秒），然後再用嘴巴像吹蠟燭一樣，緩緩、長長地把氣吐乾淨（維持6秒[...]",
        fullTipCantonese: "一齊放鬆對膊頭。用個鼻慢慢吸氣進去，感覺個肚脹起（吸大約四秒），然後用個嘴像吹蠟燭咁樣，慢慢、長長地吐氣（呼大約[...]",
        voiceText: "深呼吸。請先放鬆肩膀。跟著我：鼻子吸氣……一、二、三、四；嘴巴慢慢吐氣……一、二、三、四、五、六。重複做幾次，讓心情[...]",
        voiceTextCantonese: "吸口氣，呼口氣。放鬆下膊頭，跟著我一齊：鼻慢慢吸氣：一、二、三、四；口吐出長長氣：一、二、三、四、五、六。重複[...]"
      },
      {
        id: "he_rest",
        emoji: "🛀",
        ...
        fullTip: "今天活動得很豐富，身體可能有點累了。洗個溫暖的熱水澡，或者用溫熱水泡泡腳，能極大放鬆緊繃的小腿與足部肌肉，舒緩一整天的[...]",
        fullTipCantonese: "今日你活動得非常豐富，身骨都有啲攰啦。洗個溫水澡、或者倒盆暖水浸下腳，對舒緩小腿僵硬最有用，可以舒緩全日疲倦。睏[...]",
        voiceText: "今天辛苦了，早點休息吧。可以泡個溫水腳，活動活動，放鬆僵硬的肌肉，靜心讓大腦好好放鬆，準備睡個好覺吧。",
        voiceTextCantonese: "今日辛苦你啦，早點上床休息。可以用熱水泡泡腳，舒解你全身疲勞，放鬆條筋骨。準備舒暢瞓個好覺。"
      },
      {
        id: "he_sleep",
        emoji: "🛏️",
        ...
        fullTip: "維持規律的作息，是擁有強健免疫力的不二法門。請於每天固定的時間睡覺，避免在床上滑手機、看強光。維持房間舒適的溫度與安靜[...]",
        fullTipCantonese: "每日準時睏覺，建立規律生活，係令身體保持強健身心和免疫力嘅好方法！上咗床就唔好玩電話或者睇強光。搞好被褥，保持間[...]",
        voiceText: "晚安，時候不早了，按時睡覺對身體最好。整理一下床鋪，蓋好被子，祝您今晚做個香甜的美夢，明天見！",
        voiceTextCantonese: "晚安，夜拉，夠鐘睏啦。蓋實好被子，祝今晚有個美夢。我哋明朝見囉！"
      }
    ]
  },
  {
...
export function getBestVoice(voices: SpeechSynthesisVoice[], lang: "zh-HK" | "zh-TW"): SpeechSynthesisVoice | null {
  ...
  if (lang === "zh-HK") {
    // Cantonese matching
    // 1. Strict language code check - support iOS yue-Hant-HK and other variants
    const match1 = voices.find(v => {
      const l = clean(v.lang);
      return l === "yue-hant-hk" || l === "yue-hk" || l === "zh-hk" || l === "zh-yue-hk";
    });
    if (match1) return match1;

    // 2. Substrings in language code or name (e.g., yue, cantonese, sin-ji)
    const match2 = voices.find(v => {
      const l = clean(v.lang);
      const n = v.name.toLowerCase();
      return l.includes("yue") || n.includes("cantonese") || n.includes("sinji") || n.includes("sin-ji") || n.includes("hong kong");
    });
    ...
    // 2. Substrings in name/lang for Taiwan Mandarin - support Ting-Ting voice
    const matchTW2 = voices.find(v => {
      const l = clean(v.lang);
      const n = v.name.toLowerCase();
      return l.includes("zh-tw") || l.includes("hant-tw") || l.includes("cmn-tw") || n.includes("taiwan") || n.includes("meijia") || n.includes("mei-jia") || n.includes("ting-ting") || n.includes("tingting");
    });
    ...
    const matchCN2 = voices.find(v => {
      const l = clean(v.lang);
      const n = v.name.toLowerCase();
      return l.includes("zh-cn") || l.includes("hans-cn") || l.includes("zh-hans") || l.includes("cmn-cn") || n.includes("tingting") || n.includes("ting-ting") || n.includes("mainland") || n.includes("liaoliao");
    });
  ...
  const anyZhMatched = voices.find(v => {
    const l = clean(v.lang);
    return l.startsWith("zh") || l.includes("yue") || l.startsWith("cmn");
  });

...
export const INSTRUCTION_CATEGORIES: CategoryGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        fullTip: "坐在穩固桌椅，雙腳踩實地面。雙手叉腰或輕扶大腿，上身慢慢向前微傾，低頭弓背，深呼吸，感受後背肌肉拉伸，停留5秒後起身。這能有效舒緩脊椎緊繃與背部痠痛。",
        fullTipCantonese: "坐喺穩陣椅上，兩隻腳踩實地板。雙手叉腰或者輕扶大腿，上身慢慢向前傾少少，耷低頭、拱起背脊，深呼吸，感受後背肌肉拉平，停五秒後起身。呢個動作可以有效舒緩背部僵硬同腰酸背痛。",
      ...
      },
      {
        ...
        fullTip: "雙手在胸前伸直。雙手用力張開，十指盡量展開到最大，維持2秒；然後用力握緊拳頭，維持2秒。這樣一開一合為一次，連續做10次。這項運動能刺激末梢循環，保持手指靈活，還對大腦活化大大幫助！",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fullTipCantonese: "滾湯同熱餸熱辣辣啱啱出爐，熱度好高，食之前一定要吹吹佢，唔好求快。一筷子一筷子慢慢夾，一細口一細口飲湯。食粥或者食湯麵嗰陣，最緊要慢慢噍，唔好心急，好容易燙到人或者淥親喉嚨。",
      ...
      },
      {
        ...
        fullTipCantonese: "食多啲綠色蔬菜能提供滿滿膳食纖維、維它命同豐富營養，不單止可以改善便秘，幫助排便，對維持血壓平穩都好有益處！今日餐盤裏嘅菜菜，記住食多兩淡，健康滿滿！",
      ...
      },
      {
        ...
        fullTipCantonese: "食嘢嗰陣，每一一小口最好喺口中慢慢嚼足十五至二十下。把食物咬得碎振一啲，落去肚入面就最容易消化吸收，最能減少肚脹脹胃氣、肚痛唔舒服，仲最能體會到嘢食本身嘅清甜美味！",
      ...
      },
      {
        ...
        voiceTextCantonese: "你食飽飽未呀？如果飽啦，先喺座位上坐多陣，唔好即刻躺低瞓。等陣間可以扶住房散下步消消食，對腸胃最健康。"
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fullTipCantonese: "一齊放鬆對膊頭。用個鼻慢慢吸氣進去，感覺個肚肚脹起（吸大約四秒），然後用個嘴像吹蠟燭咁樣，慢慢、長長地吐氣（呼大約六秒）。做呢個深呼吸三到五次，可以令心跳安靜落嚟、身心放鬆。",
        voiceText: "深呼吸。請先放鬆肩膀。跟著我：鼻子吸氣……一、二、三、四；嘴巴慢慢吐氣……一、二、三、四、五、六。重複做幾次，讓心情平靜下來。",
      ...
      },
      {
        ...
        fullTipCantonese: "今日你活動得非常豐富，身骨都有啲攰啦。洗個溫水澡、或者倒盆暖水浸下腳，對舒緩小腿僵硬最有用，可以舒緩全日疲倦。瞓個安穩好夢。",
      ...
      },
      {
        ...
        fullTipCantonese: "每日準時瞓覺，建立規律生活，係令身體保持強健身心和免疫力嘅好方法！上咗床就唔好玩電話或者睇強光。搞好被褥，保持間房溫暖安靜，祝你今晚做個甜甜嘅好夢，明朝精神滿滿起床！",
        voiceText: "晚安，時候不早了，按時睡覺對身體最好。整理一下床鋪，蓋好被子，祝您今晚做個香甜的美夢，明天見！",
        voiceTextCantonese: "晚安，夜拉，夠鐘瞓啦。蓋實好被子，祝今晚有個美夢。我哋明朝見囉！"
      }
    ]
  },
  {
